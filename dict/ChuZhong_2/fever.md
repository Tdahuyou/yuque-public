...
vi. [医]发烧；狂热；患热病
`run a temperature` `go wild`

# 同根

- adj. `feverish` 发热的；极度兴奋的
- adj. `fevered` 发烧的；激动的；激昂的
- adj. `feverous` 发烧的（等于feverish）；疯狂的
- adv. `feverishly` 狂热地；兴奋地
- n. `feverishness` 疯狂，狂燥；发烧
- v. `fevered` 发热；高度兴奋（fever的过去式和过去分词）
