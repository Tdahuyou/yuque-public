...
用船(ship)运送羊(sheep)出口外国

# 同义

vt. 运送，乘船；以船运送
`freight` `transit` `forward`

vi. 上船；乘船旅行；当船员
`to go aboard` `take water`
...
- n. `shipping` [船] 船舶，船舶吨数；海运；运送
- n. `shipper` 托运人；发货人；货主
- n. `shipmate` 同船水手，同船船员
- v. `shipping` 运送，乘船（ship的ing形式）
