...
n. 被动语态
`the passive form of a verb, for example ‘was destroyed’ in the sentence ‘The building was destroyed during the war.’`



pass (看作passi， 感情) + ive (…的) → 感情用事的 → 被动的
...
- n. `passivation` [化学] 钝化；钝化处理
- n. `passivity` 被动性；被动结构；无抵抗
- n. `passiveness` 被动；顺从
