...
- adj. `fermentable` 可发酵的；沸腾的
- n. `ferment` 发酵；酵素；动乱
- vi. `ferment` 发酵；动乱
- vt. `ferment` 使发酵；酝酿；使动乱
...
At that time, any fish caught had to be preserved. The only method possible was by fermentation.
在那个年代，所有捕来的鱼都要被贮存起来，唯一可能的贮存方法就是发酵。

They baited others with CO2 produced by fermentation when yeast is mixed with a sugar solution.
他们用酵母与糖溶液混合后发酵产生的CO2作为另一些陷阱的饵。
