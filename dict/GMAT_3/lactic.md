...
- n. `lactate` [有化] 乳酸盐
- n. `lactation` 哺乳；哺乳期；授乳（形容词lactational）；分泌乳汁
- vi. `lactate` 分泌乳汁；喂奶
...
A low-alcohol cactus lactic acid drink was developed by co-fermentation of microzyme and lactobacillus using malt, cactus, and milk as materials.
