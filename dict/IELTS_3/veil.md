...
vt. 蒙着面纱；掩饰
`if something is veiled in mystery etc, people do not know the truth about it so it seems strange or mysterious`



邪恶的(evil)人总是试图掩饰(veil)自己
...
- v. `veiling` 用面纱遮掩；带面纱（veil的ing形式）
