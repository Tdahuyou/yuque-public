...
pest(瘟疫) + i + cide(杀) → 杀害虫的东西 → 杀虫剂

# 同义

n. [农药]杀虫剂
`insecticide` `insect repellent` `insect killer` `insect spray` `anabasin`
...
This resulted in the contamination of the bags used in that facility's fluid bed dryers with pesticide contamination.
这导致了由于工厂的流体床干燥器被杀虫剂污染而把使用的包装袋污染。
