...
- adj. `sectional` 部分的，节的；可组合的
- adj. `sectorial` 扇形的，适于切割的
- n. `sector` 部门；扇形，扇区；象限仪；函数尺
- n. `sectional` 组合式家俱
- n. `sectionalism` 地方偏见，地方主义
- n. `sectionalization` 分节；分区；分组
- vt. `sector` 把…分成扇形
- vt. `sectionalize` 使具有地方性；划分
