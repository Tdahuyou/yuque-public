...
n. 通讯；传达；交通
`the way people express themselves so that other people will understand`
...
- adj. `communicative` 交际的；爱说话的，健谈的；无隐讳交谈的
...
- vi. `communicate` 通讯，传达；相通；感染
- vt. `communicate` 传达；感染；显露
