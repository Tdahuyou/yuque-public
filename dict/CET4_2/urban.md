...
urb(城市) ＋ an(…的) → 城市的； 发音记忆： “饿奔” → 初到大都市讨生活， 饿得狂奔 → 都市的
...
- adj. `urbane` 彬彬有礼的，温文尔雅的；都市化的
- adj. `urbanized` 城市化的
- n. `urbanization` 都市化；文雅化
- n. `urbanity` 都市风格；雅致；有礼貌
- v. `urbanized` 使城市化（urbanize的过去式）
- vt. `urbanize` 使都市化；使文雅
