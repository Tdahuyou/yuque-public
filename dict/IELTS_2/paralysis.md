...
- adj. `paralyzed` 瘫痪的；麻痹的
- adj. `paralytic` 麻痹的；瘫痪的；中风的
- n. `paralytic` 中风患者；麻痹患者
- v. `paralyzed` 使麻痹；使无力；使失去勇气（paralyze的过去分词）
- vt. `paralyze` 使麻痹；使瘫痪
- vt. `paralyse` 使……无力；使……麻痹；使……瘫痪
