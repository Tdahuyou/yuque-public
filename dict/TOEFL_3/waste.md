...
adj. 无用的，废弃的；荒芜的
`waste materials, substances etc are unwanted because the good part of them has been removed`
...
n. 浪费；废物；荒地；损耗；地面风化物
`refuse` `garbage` `dissipation` `wear`

vt. 浪费；消耗；使荒芜
`lose` `spend` `consume`

vi. 浪费；变消瘦；挥霍钱财
`trifle away` `fiddle away`

adj. 废弃的；多余的；荒芜的
`spare` `unnecessary` `redundant`

# 同根

- adj. `wasted` 浪费的
- adj. `wasteful` 浪费的，不经济的；奢侈的
