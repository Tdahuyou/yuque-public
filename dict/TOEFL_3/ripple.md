...
谜语(riddle)变dd为pp → 细浪(ripple)

# 同义

n. 波纹；涟漪；[物]涟波
`cockles` `Sparkling Raindrops`

# 同根

- adj. `rippling` 潺潺流水般声音的；起涟漪的
- adj. `rippled` 起微波的；起涟漪的
- v. `rippling` 使起涟漪；呈波状起伏（ripple的ing形式）
- vt. `rippled` 使…起涟漪；使…起微波（ripple的过去分词）
