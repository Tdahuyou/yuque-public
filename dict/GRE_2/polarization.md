...
n. [物]偏振(现象),极化(作用),两极化,分化


# 同根

- adj. `polar` 极地的；两极的；正好相反的
- n. `polar` 极面；极线
- n. `polarity` [物] 极性；两极；对立
- n. `polaroid` 人造偏光板；[光] 偏振片
- vi. `polarize` 极化；偏振；两极分化
- vt. `polarize` （使）极化；（使）偏振；（使）两极分化
- vt. `polarise` 极化（等于polarize）
