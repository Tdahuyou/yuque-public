...
- adj. `flex` 弹性工作制的
- adj. `flexile` 可弯曲的；柔韧的；可变通的
- adj. `flexuous` 动摇不定的；弯曲的；波状的；[生物] 之字形的；不稳定的
- adv. `flexibly` 灵活地；易曲地；柔软地；有弹性地
- n. `flexibility` 灵活性；弹性；适应性
- n. `flex` 屈曲；电线；松紧带
- n. `flexure` 屈曲；折褶；弯曲部分
- n. `flexion` 弯曲，弯曲状态；弯曲部分
- n. `flexibleness` 可挠性；柔软性
- vi. `flex` 弯曲；收缩
- vt. `flex` 折曲；使收缩
