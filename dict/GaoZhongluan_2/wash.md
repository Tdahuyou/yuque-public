...
- adj. `washing` 洗涤用的，清洗用的
- adj. `washable` 耐洗的；可洗的
- adj. `washy` 水分多的；淡的；多水的；无力的
- n. `washer` [机] 垫圈；洗涤器；洗衣人
- n. `washing` 洗涤；洗涤剂；要洗的衣物
- n. `washable` 可洗的布料；耐洗织物
- v. `washing` 洗；使受洗礼（wash的ing形式）
