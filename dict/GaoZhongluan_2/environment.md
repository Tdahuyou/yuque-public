...
en(在…中)+viron(圆)+ment→自身所在的"圆"中→环境
...
- adj. `environmental` 环境的，周围的；有关环境的
- adv. `environmentally` 有关环境方面
- n. `environmentalist` 环保人士；环境论者；研究环境问题的专家
- n. `environmentalism` 环境保护论
- vt. `environ` 环绕；包围；（敌意地或保护性的）围住
