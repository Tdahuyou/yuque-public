...
n. 投射；规划；突出；发射；推测
`the act of projecting a film or picture onto a screen`



pro(提前) + ject(扔) + ion → 提前扔出来 → 规划； 预测

# 同义

n. [心理][数]投射；规划；突出；发射；推测
`emission` `theory` `speculation` `planning` `sending`

# 同根

- adj. `projecting` 突出的；伸出的
- n. `project` 工程；计划；事业
- n. `projector` [仪] 投影仪；放映机；探照灯；设计者
