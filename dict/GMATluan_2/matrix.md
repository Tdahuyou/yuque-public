...
`an arrangement of numbers, letters, or signs in rows and  column s  that you consider to be one amount, and that you use in solving mathematical problems`
...
n. [数]矩阵；模型；[生物][地质]基质；母体；子宫；脉石
`model` `shape` `former` `substrate`
