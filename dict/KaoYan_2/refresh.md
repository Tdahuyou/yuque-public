...
v. 更新；使……恢复；使……清新；消除……的疲劳
`if you refresh your computer screen while you are connected to the Internet, you make the screen show any new information that has arrived since you first began looking at it`



re(重新)+fresh(新鲜的)→重新变得新鲜→(使)精神振作
