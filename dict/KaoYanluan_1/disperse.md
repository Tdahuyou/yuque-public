...
- adj. `dispersed` 散布的；被分散的；被驱散的
- adj. `dispersive` 分散的；弥散的
- n. `dispersion` 散布；[统计][数] 离差；驱散
- n. `dispersal` 分散；传播；散布；疏散；消失
- v. `dispersed` 分散；传播（disperse的过去分词）
...
radioactivePolice used tear gas to disperse the crowd.
警察用催泪瓦斯驱散人群。
