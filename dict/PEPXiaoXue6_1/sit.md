...
vi. 坐；位于
`lie on` `be located on`

# 同根

- adj. `situate` 位于…的
- adj. `sitting` 坐着的；孵卵中的；在任期中的
- adj. `situated` 位于…的；处于…境遇的
- n. `sitting` 入席，就坐；开庭；孵卵；坐着的一段时间
- n. `sitter` 代人临时看管小孩的人；当模特儿的人；坐着的人
- n. `siting` 选址；定位
- v. `sitting` 坐；坐落（sit的ing形式）
- v. `situated` 使位于；使处于（situate的过去分词）
- v. `siting` 给…造址；设置（site的ing形式）
- vt. `situate` 使位于；使处于
