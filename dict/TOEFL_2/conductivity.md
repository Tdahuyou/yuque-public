...
- n. `conduct` 进行；行为；实施
- n. `conductor` 导体；售票员；领导者；管理人
- n. `conduction` [生理] 传导
- n. `conductance` [电] 电导；导率；电导系数
- n. `conductress` 女向导；女车长；女指挥；女售票员
- vi. `conduct` 导电；带领
- vt. `conduct` 管理；引导；表现
...
It possesses incredible strength and elasticity, while its exceptionally high conductivity and use in flexible semiconductors  could soup up computing.
