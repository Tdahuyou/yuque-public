...
top(地方) + o + graph(写； 图) + y → 地形学

# 同义

n. 地势；地形学；地志
`terrain` `surface relief`

# 同根

- adj. `topographic` 地形测量的；地志的；地形学上的
- adj. `topographical` 地志的；地形学的（等于topographic）
- adv. `topographically` 从地形上；在地形构造方面
- n. `topology` 拓扑学；地志学；局部解剖学
