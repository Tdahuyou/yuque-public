...
vi. 上升，上涨；升起；站起，起床；增强，增加；反抗
`to increase in number, amount, or value`

n. 上涨，增加，升高；兴起，升高；加薪；岗，高地，高坡
`an increase in number, amount, or value`

# 同义

vi. 上升；增强；起立；高耸
`raise` `arise` `tower` `go up` `climb`

n. 上升；高地；增加；出现
`height` `occurrence` `appearance` `emergence` `enhancement`
