...
n. 发展；展开；事态发展，新情况；开发；发展的结果
`the process of gradually becoming bigger, better, stronger, or more advanced`

# 同义

n. 发展；开发；[生物]发育；[建]住宅小区（专指由同一开发商开发的）；[摄]显影
`exploitation` `growth` `making` `advance` `progress`
...
- vi. `develop` 发育；生长；进化；显露
- vt. `develop` 开发；进步；使成长；使显影
