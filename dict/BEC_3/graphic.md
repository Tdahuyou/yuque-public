...
adj. 〔叙述或描写〕清楚详细的，细致的〔尤指包含令人不愉快的细节〕
`a graphic account or description of an event is very clear and gives a lot of details, especially unpleasant ones`



graph(写； 图) + ic(…的) → 文字的， 图表的
