...
n. [临床]休克；震惊；震动；打击；禾束堆
`blow` `stroke` `strike` `hit`

vt. [临床]使休克；使震惊；使震动；使受电击；把…堆成禾束堆
`scandalize` `astound`
...
- adj. `shocked` 震惊的；震撼的
- adj. `shocking` 令人震惊的；可怕的，令人厌恶的；糟糕的
- n. `shocker` 令人震惊的人或事物；耸人听闻的故事或小说
- v. `shocked` 使震动（shock的过去式）
- v. `shocking` 感到震惊；震动；冲突（shock的ing形式）
