...
v. 围住，隔开；回避，搪塞
`to answer someone’s questions in a clever way in order to get an advantage in an argument`
...
- n. `fencing` 剑术；围墙；筑栅栏的材料
- n. `fencer` 击剑者；剑术家；（澳）篱笆匠
- v. `fencing` 击剑；围住；避开（fence的ing形式）
